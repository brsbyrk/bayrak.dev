...
import { Highlight, Info, ProjectCard } from '@site/src/components/Blog';
...
To ensure high performance, I built the backend using <Highlight color="#e65100">Rust</Highlight>, known for its speed and efficiency, and integrated <Highlight>Tauri</Highlight> to make Remage a cross-platform desktop app. The frontend uses <Highlight color="#61dafb">React</Highlight> and <Highlight color="#06b6d4">Tailwind CSS</Highlight>, providing a responsive, modern interface that's easy to navigate.

<Info title="Stack">
  Rust + Tauri + React + Tailwind — a lightweight stack for a lightweight tool.
</Info>
...
<ProjectCard
  name="Remage"
  description="A lightweight cross-platform desktop app for image resizing and watermarking, built with Rust and Tauri."
  link="https://github.com/brsbyrk/remage"
/>
